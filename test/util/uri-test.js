...
require('util/test').run({
	...
	testLocation  : function () {
		var assert = this.assert, uri = this.uri;
	...
	testNormal    : function () {
		...
		assert.equal(uri.resolve('js/test.js', 'http://another.domain.com/tests/util/uri.html'), 'http://another.domain.com/tests/util/js/test-debug.js');
	...
	testRelative  : function () {
		...
		assert.equal(uri.resolve('../util/js/test.js', 'http://another.domain.com/tests/util/uri.html'), 'http://another.domain.com/tests/util/js/test-debug.js');
	...
	testAbsolute  : function () {
		...
		assert.equal(uri.resolve('/o_p/tests/js/test.js', 'http://another.domain.com/tests/util/uri.html'), 'http://another.domain.com/o_p/tests/js/test-debug.js');
